...
if ($_POST) {
  ...
  $query = mysqli_query($connection, "insert into tbl_manager(manager_name, manager_email,manager_password) 
values('{$name}','{$email}','{$password}')");


  if ($query) {
    echo "<script>alert('Manager Added');window.location='add-manager.php';</script>";
  }
}
...
<head>
  ...
  <title>InventoTrack_ADD_MANAGER</title>
