...
<head>
  ...
  <title>InventoTrack_ADMIN_DISPLAY_USERS</title>
          ...
          <div class="col-md-12">
            <div class="card card-info">
              ...
              if(isset($_GET['did'])){
                //echo "yes";
                $did = $_GET['did'];
                $deletequery = mysqli_query($connection, "delete from tbl_user where user_id='{$did}'");
                if($deletequery){
              ...
              echo "<div class='card-body'>";
                ...
                echo "<table class='table table-bordered'>";
                  ...
                  while($row = mysqli_fetch_array($query)){
                      ...
                      echo "<td>{$row['user_mobile_number']}</td>";
                      echo "<td>{$row['user_address']}</td>";                    
                      //echo "<td><a href='edit-user.php?eid={$row['user_id']}'>Edit</a> | <a href='display-user.php?did={$row['user_id']}'>Delete</a></td>";
                      echo "</tr>";
                      echo "</tbody>";
                }
                echo "</table>";
