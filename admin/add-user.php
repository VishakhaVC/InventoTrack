...
values('{$username}','{$fullname}','{$email}','{$password}','{$mobilenumber}','{$address}')");


  if ($query) {
    echo "<script>alert('Record Added');window.location='add-user.php';</script>";
  }
}
...
<head>
  ...
  <title>InventoTrack_ADMIN_ADD_USER</title>
                ...
                <form method="post">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" autocomplete="off" name="txt3" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Password</label>
                      <input type="password" class="form-control" autocomplete="off" name="txt4" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" class="form-control" autocomplete="off" name="txt6" required>
                    </textarea>
                    </div>
