...
if ($_POST) {
  ...
  $query = mysqli_query($connection, "insert into tbl_category(category_name, category_details) 
values('{$categoryname}','{$categorydetail}')");


  if ($query) {
    echo "<script>alert('Category Added');window.location='add-category.php';</script>";
  }
}
...
<head>
  ...
  <title>InventoTrack_MANAGER_ADD_CATEGORY</title>
                ...
                <form method="post" id="myform">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea type="text" class="form-control" autocomplete="off" name="txt2" required>
                    </textarea>
                    </div>
  ...
  <script>
    $(document).ready(function () {
      $("#myform").validate({
        ...
        messages: {
          txt1: "*Please enter name",
          txt2: "*Please enter details",
        },
      });
    });
  </script>
