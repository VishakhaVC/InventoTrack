...
if ($_POST) {
  ...
  $query = mysqli_query($connection, "insert into tbl_order_details(order_id,product_id,order_quantity,order_price,order_total_amount) 
values('{$orderid}','{$productid}','{$quantity}','{$price}','{$totalamount}')");


  if ($query) {
    echo "<script>alert('Record Added');window.location='add-order-details.php';</script>";
  }
}
...
<head>
  ...
  <title>InventoTrack_ADMIN_ADD_ORDER_DETAILS</title>
                ...
                <form method="post" id="myform">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      {
                        echo "<option value='{$droprow['order_id']}'>{$droprow['order_date']}</option>";
                      }
                      echo "</select>";                    
                      ?>
