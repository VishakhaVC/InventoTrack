...
<head>
  ...
  <title>InventoTrack_MANAGER_DISPLAY_CATEGORY</title>
          ...
          <div class="col-md-12">
            <div class="card card-info">
              ...
              if(isset($_GET['did'])){
                //echo "yes";
                $did = $_GET['did'];
                $deletequery = mysqli_query($connection, "delete from tbl_category where category_id='{$did}'");
                if($deletequery){
              ...
              echo "<div class='card-body'>";
                ...
                echo "<table class='table table-bordered'>";
                  ...
                  while($row = mysqli_fetch_array($query)){
                      ...
                      echo "<td>{$row['category_details']}</td>";                                        
                      echo "<td><a href='edit-category.php?eid={$row['category_id']}'> Edit</a> | 
                      <a href='display-category.php?did={$row['category_id']}'>Delete</a></td>";
                      echo "</tr>";
                      echo "</tbody>";
                }
                echo "</table>";
